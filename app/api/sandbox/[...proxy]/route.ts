...
//     console.log("Connected to GameLabSandbox database");
//     return sandboxConnection;
//   } catch (error) {
...
//   // Mirror platform collection names exactly: "games", "gamesessions", "gamedatas"
...
//     // allow extra fields from platform side without strict failures
//   }, { strict: false });
...
//     GameSession:
//       conn.models.GameSession || conn.model("GameSession", GameSessionSchema, "gamesessions"),
//     GameData:
//       conn.models.GameData || conn.model("GameData", GameDataSchema, "gamedatas"),
//   };
// }
...
//     if (path === 'game-session' || path === 'sandbox/game-session') {
...
//       // Ensure there's a Game doc for this gameId (mirror prod behavior of having all three)
//       // Use minimal fields; allow platform to enrich later.
...
//     if (path === 'game-data' || path === 'sandbox/game-data') {
//       if (!body.sessionId) {
